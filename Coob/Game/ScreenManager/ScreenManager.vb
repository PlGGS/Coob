Public Class ScreenManager
    ...
    Public Sub addScreen(ByRef screen As Screen)
        screens.Add(screen)
    ...
    Public Sub removeScreen(ByRef screen As Screen)
        screens.Remove(screen)
        game.Controls.Remove(screen)
    End Sub

    Public Sub hideScreen(ByRef screen As Screen)
        screen.hideScreen()
        screen.state = ScreenState.Hidden
        screen.SendToBack()
    End Sub

    Public Sub showScreen(ByRef screen As Screen)
        screen.showScreen()
        screen.state = ScreenState.Visible
        screen.BringToFront()
    End Sub

    Public Sub setActiveScreen(ByRef screen As Screen)
        activeScreen = screen
        screen.BringToFront()
        screen.state = ScreenState.Visible
